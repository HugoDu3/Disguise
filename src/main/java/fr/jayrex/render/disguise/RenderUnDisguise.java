...
public class RenderUnDisguise extends RenderLivingBase<AbstractClientPlayer> {
    ...
    public void doRender(AbstractClientPlayer entity, double x, double y, double z, float entityYaw, float partialTicks) {
        MinecraftForge.EVENT_BUS.post(new Events.Render.RenderCustomLivingEvent.Pre<AbstractClientPlayer>(entity, this, x, y, z));
        ...
        MinecraftForge.EVENT_BUS.post(new Events.Render.RenderCustomLivingEvent.Post
                <AbstractClientPlayer>(entity, this, x, y, z));
    }

package fr.jayrex.render.disguise;

import com.google.common.collect.Lists;
import fr.jayrex.st.Events;
...
public class RenderDisguise extends Render<EntityLivingBase> {
    private ResourceLocation texture;


    public RenderDisguise(RenderManager renderManagerIn, ModelBase model, ResourceLocation text) {
    ...
    protected List<LayerRenderer<EntityLivingBase>> layerRenderers = Lists.<LayerRenderer<EntityLivingBase>>newArrayList();
    protected boolean renderMarker;

    public static float NAME_TAG_RANGE = 64.0f;
    public static float NAME_TAG_RANGE_SNEAK = 32.0f;

    public <V extends EntityLivingBase, U extends LayerRenderer<EntityLivingBase>> boolean addLayer(U layer) {
        return this.layerRenderers.add((LayerRenderer<EntityLivingBase>) layer);
    }
    ...
    public void doRender(EntityLivingBase entity, double x, double y, double z, float entityYaw, float partialTicks) {
        MinecraftForge.EVENT_BUS.post(new Events.Render.RenderCustomLivingEvent.Pre<EntityLivingBase>(entity, this, x, y, z));
        ...
        MinecraftForge.EVENT_BUS.post(new Events.Render.RenderCustomLivingEvent.Post<EntityLivingBase>(entity, this, x, y, z));
    }
    ...
    protected void renderLayers(EntityLivingBase entitylivingbaseIn, float limbSwing, float limbSwingAmount, float partialTicks, float ageInTicks, float netHeadYaw, float headPitch, float scaleIn) {
        for (LayerRenderer<EntityLivingBase> layerrenderer : this.layerRenderers) {
